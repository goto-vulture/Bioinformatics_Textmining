...
#ifndef GLOBAL_CLI_NO_CREATION_TIME_DEFAULT
#define GLOBAL_CLI_NO_CREATION_TIME_DEFAULT false
#else
#error "The macro \"GLOBAL_CLI_NO_CREATION_TIME_DEFAULT\" is already defined !"
#endif /* GLOBAL_CLI_NO_CREATION_TIME_DEFAULT */

#if defined(__STDC_VERSION__) && __STDC_VERSION__ >= 201112L
IS_PTR(GLOBAL_CLI_INPUT_FILE_DEFAULT)
IS_PTR(GLOBAL_CLI_INPUT_FILE_DEFAULT_2)
IS_PTR(GLOBAL_CLI_OUTPUT_FILE_DEFAULT)
IS_INT(GLOBAL_CLI_FORMAT_OUTPUT_DEFAULT)
IS_INT(GLOBAL_CLI_SENTENCE_OFFSET_DEFAULT)
IS_INT(GLOBAL_CLI_WORD_OFFSET_DEFAULT)
IS_INT(GLOBAL_RUN_ALL_TEST_FUNCTIONS_DEFAULT)
IS_INT(GLOBAL_CLI_SHOW_TOO_LONG_TOKENS_DEFAULT)
IS_INT(GLOBAL_CLI_NO_PART_MATCHES_DEFAULT)
IS_INT(GLOBAL_CLI_NO_FULL_MATCHES_DEFAULT)
IS_INT(GLOBAL_CLI_KEEP_RESULTS_WITH_ONE_TOKEN_DEFAULT)
IS_FLOAT(GLOBAL_ABORT_PROCESS_PERCENT_DEFAULT)
IS_INT(GLOBAL_CLI_NO_CREATION_TIME_DEFAULT)
...
_Bool GLOBAL_CLI_NO_CREATION_TIME               = GLOBAL_CLI_NO_CREATION_TIME_DEFAULT;
...
extern void Set_CLI_Parameter_To_Default_Values (void)
{
    ...
    GLOBAL_CLI_NO_CREATION_TIME             = GLOBAL_CLI_NO_CREATION_TIME_DEFAULT;
...
#ifdef GLOBAL_CLI_NO_CREATION_TIME_DEFAULT
#undef GLOBAL_CLI_NO_CREATION_TIME_DEFAULT
#endif /* GLOBAL_CLI_NO_CREATION_TIME_DEFAULT */
